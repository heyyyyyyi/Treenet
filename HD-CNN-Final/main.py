...
parser.add_argument('--dataset', default='cifar-10', type=str, help='Determine which dataset to be used')
parser.add_argument('--num_superclasses', default=2, type=int, help='The number of cluster centers')
parser.add_argument('--num_epochs_pretrain', default=100, type=int, help='The number of pre-train epoches')
parser.add_argument('--num_epochs_train', default=100, type=int, help='The number of train epoches')
...
print("Pretrainloader shape: ", pretrainloader.dataset.train_data.shape)
