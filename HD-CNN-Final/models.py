...
class HD_CNN(nn.Module):
    def __init__(self, args):
        ...
        self.coarse = Independent(self.args, self.args.num_classes)
        self.fines = {}
    ...
    # After spectrual clustering, assign the fine classes 
    def assign_fine_classes(self):
...
class Independent(nn.Module):
    def __init__(self, args, num_classes, map_outputs=None):
        ...
        self.fc3 = nn.Linear(1*1*1024, num_classes)
