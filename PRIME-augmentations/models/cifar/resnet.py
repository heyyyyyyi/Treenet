...
@utils.register_model(dataset='cifar10', name='lightresnet20')
@utils.register_model(dataset='cifar100', name='lightresnet20')
class LightResNet20(LightResnet):
    def __init__(self, num_channels=3, num_classes=10, linear_bias=True, bn_affine=True, **kwargs):
        super(LightResNet20, self).__init__(
            BasicBlock, [2, 2, 2], num_channels=num_channels, num_classes=num_classes,
            linear_bias=linear_bias, bn_affine=bn_affine
        )
