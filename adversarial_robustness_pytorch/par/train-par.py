...
from .train import TreeEnsemble
...
parse.add_argumen('--strategy', type=str, default='linear', choices=['exponential', 'linear'], help='Strategy for alpha decay.')
parse.add_argument('--softroute', type=bool, default=False, help='Use soft routing for the tree ensemble.')
parse.add_argument('--unkown_classes', type=bool, default=False, help='Use unknown classes for the tree ensemble.')
